<template>
  <div class="formCollectionPayment">
    <form action="/action_page.php">
      <label for="idpago">Nro. Recaudo Pago</label>
      <input
        class="c"
        type="text"
        id="idpago"
      ...
      />
      <br />
      <label for="idcuentacobro">Nro. Cuenta Cobro</label>
      <input
        class="c"
        type="text"
        id="idcuentacobro"
      ...
      <label for="idapartamento">Nro. Apartamento</label>
      <input class="c" type="text" id="idapartamento" name="idapartamento" />
     
     
      <label for="idconcepto">Concepto de Cobro</label>
      <select id="idconcepto" name="idconcepto">
        <option value="">...</option>
        <option value=1>1. Cobro Administración</option>
        <option value=2>2. Cuota Extraordinaria</option>
    ...
    <input class ="a" type="date" name="fechapago" 
    value="1920-01-01" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"
    id="fechapago" 
    >

      <label for="importe"> Valor Pagado $ </label>
      <input
        class="b"
        type="text"
        id="importe"
